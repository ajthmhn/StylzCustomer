...
{   
    ...
    if ([collectionView respondsToSelector:@selector(setSemanticContentAttribute:)])
    [collectionView setSemanticContentAttribute:UISemanticContentAttributePlayback];
