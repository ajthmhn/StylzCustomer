...
class CartViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if getCartData() == nil{
            ...
            lblVatHead.text = LocalizationSystem.sharedInstance.localizedStringForKey(key: "vat", comment: "") //changed
...
//            cell.imgProduct.image = UIImage(named: K.placeHolderImage.scissor)
