...
struct stryBrdId {
    ...
    static let subscription1 = "GetPremimumViewController"
    static let subscription2 = "GetPremimun2ViewController"
    static let myPlan = "MyPlanViewController"
    static let cancelPlan = "CancelSubscriptionViewController"
    static let Rating = "AddRatingViewController"
    static let AddSalonRatings = "AddSalonRatingsViewController"
    static let AddEmployeeRatings = "AddEmployeeRatingsViewController"
...
func saveUserDetails(userDetails:User){
    ...
    UserDefaults.standard.set(dict, forKey: K.UserDefaultsKeys.user_details)
    UserDefaults.standard.synchronize()
}
...
func getUserDetails() -> [String:Any]?{
    return UserDefaults.standard.dictionary(forKey: K.UserDefaultsKeys.user_details) ?? nil
}

func deleteUserDetails(){
    let defaults = UserDefaults.standard
    defaults.set(nil, forKey: K.UserDefaultsKeys.user_details)
...
func setImage(imageView : UIImageView, url : String, placeHolderImg:String? = nil){
